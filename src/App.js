...
function App() {
  ...
  return (
    <div className="App">
        ...
        <button style={{borderColor:'white',borderRadius:30,width:'30%',height:'40%',color: 'white',backgroundColor:'blue', animation: 'shake 0.5s' }} onClick={() => console.log('Button Clicked')}>
            지금 무표 체험하기
          </button>
        </div>   
    </div>
